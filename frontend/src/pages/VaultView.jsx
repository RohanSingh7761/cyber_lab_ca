    ...
    return (
        <div className="min-h-screen bg-black">
                    ...
                    <div className="flex items-center justify-between gap-3">
                        <div className="flex items-center gap-2 sm:gap-4 flex-1 min-w-0">
                            <button
                                ...
                                className="text-gray-400 hover:text-white transition-colors flex items-center gap-1 sm:gap-2 text-sm sm:text-base shrink-0"
                            >
                            ...
                            <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-linear-to-br from-primary via-primary to-orange-500 rounded-lg flex items-center justify-center shadow-lg shadow-primary/30 shrink-0">
                        ...
                        {vault?.isOwner && (
                            <button
                                ...
                                className="px-3 sm:px-6 py-2 sm:py-2.5 bg-linear-to-r from-primary via-primary to-orange-500 hover:from-orange-500 hover:to-primary text-white font-semibold rounded-lg transition-all transform hover:scale-[1.02] shadow-lg shadow-primary/30 flex items-center gap-1 sm:gap-2 text-xs sm:text-base shrink-0"
                            >
                                <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                ...
                {/* Upload Section */}
                <div className="bg-linear-to-br from-surface/50 to-black border border-border rounded-2xl p-4 sm:p-6 mb-6 sm:mb-8 backdrop-blur-xl">
                ...
                {/* Files List */}
                <div className="bg-linear-to-br from-surface/50 to-black border border-border rounded-2xl overflow-hidden backdrop-blur-xl">
                            ...
                            {files.map((file) => (
                                ...
                                >
                                    <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0 w-full">
                                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-linear-to-br from-primary/20 to-orange-600/20 rounded-lg flex items-center justify-center shrink-0">
                                            <svg className="w-5 h-5 sm:w-6 sm:h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                                            </svg>
                                        </div>
            ...
            {showPasswordPrompt && (
                <div className="fixed inset-0 bg-black/90 backdrop-blur-sm flex items-center justify-center p-4 z-50">
                    <div className="bg-linear-to-br from-surface to-black border border-border rounded-2xl p-6 max-w-md w-full shadow-2xl mx-4">
                        <div className="flex items-center gap-3 mb-4">
                            <div className="w-12 h-12 bg-linear-to-br from-primary to-orange-600 rounded-xl flex items-center justify-center">
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                onClick={unlockVault}
                                className="flex-1 px-4 py-2.5 bg-linear-to-r from-primary to-orange-600 hover:from-orange-600 hover:to-primary text-white rounded-lg transition-all shadow-lg shadow-primary/50"
                            >
                                Unlock
                            </button>
                        </div>
            ...
            {showInvite && (
                <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 z-50">
                    <div className="bg-linear-to-br from-surface to-black border border-border rounded-2xl p-6 max-w-2xl w-full shadow-2xl mx-4">
                        <div className="flex items-center gap-3 mb-4">
                            <div className="w-12 h-12 bg-linear-to-br from-primary to-orange-600 rounded-xl flex items-center justify-center">
                                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z" />
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                ...
                                className="flex-1 px-4 py-2.5 bg-linear-to-r from-primary to-orange-600 hover:from-orange-600 hover:to-primary text-white rounded-lg transition-all shadow-lg shadow-primary/50 flex items-center justify-center gap-2"
                            >
